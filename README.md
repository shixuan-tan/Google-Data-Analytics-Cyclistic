...
Note: I have also completed a separate version of this case study using R for data cleaning, analysis and visualization, along with Tableau to visualize the top stations' coordinates. You can view that version of the case study [here](https://github.com/shixuan-tan/Google-Data-Analytics-Cyclistic-R). The two projects use different years of data (2024 for SQL, 2023 for R) to intentionally analyze separate datasets for broader practice.
